...
struct icap_application_callbacks {
	int32_t (*playback_frag_ready)(struct icap_instance *icap, uint32_t frags);
	int32_t (*playback_xrun)(struct icap_instance *icap, uint32_t frags);
	int32_t (*record_frag_ready)(struct icap_instance *icap, uint32_t frags);
	int32_t (*record_xrun)(struct icap_instance *icap, uint32_t frags);
